...
import { IncidenteDeProveedorDeleteDialog } from './incidente-de-proveedor-delete-dialog';

describe('IncidenteDeProveedor Management Delete Component', () => {
  let comp: IncidenteDeProveedorDeleteDialog;
  let fixture: ComponentFixture<IncidenteDeProveedorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(IncidenteDeProveedorDeleteDialog);
