...
describe('Servicio Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('should call ServicioDeProveedor query and add missing value', () => {
      const servicio: IServicio = { id: 644 };
      const proveedorDelQueDependes: IServicioDeProveedor[] = [{ id: 6402 }];
      servicio.proveedorDelQueDependes = proveedorDelQueDependes;
      ...
      const additionalServicioDeProveedors = [...proveedorDelQueDependes];
    ...
    it('should update editForm', () => {
      ...
      const proveedorDelQueDepende: IServicioDeProveedor = { id: 6402 };
      servicio.proveedorDelQueDependes = [proveedorDelQueDepende];
      ...
      expect(comp.servicioDeProveedorsSharedCollection()).toContainEqual(proveedorDelQueDepende);
