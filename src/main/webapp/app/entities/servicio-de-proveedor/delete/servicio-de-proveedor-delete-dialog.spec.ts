...
import { ServicioDeProveedorDeleteDialog } from './servicio-de-proveedor-delete-dialog';

describe('ServicioDeProveedor Management Delete Component', () => {
  let comp: ServicioDeProveedorDeleteDialog;
  let fixture: ComponentFixture<ServicioDeProveedorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ServicioDeProveedorDeleteDialog);
