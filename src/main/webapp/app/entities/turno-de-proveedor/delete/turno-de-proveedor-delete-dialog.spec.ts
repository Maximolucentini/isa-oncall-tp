...
import { TurnoDeProveedorDeleteDialog } from './turno-de-proveedor-delete-dialog';

describe('TurnoDeProveedor Management Delete Component', () => {
  let comp: TurnoDeProveedorDeleteDialog;
  let fixture: ComponentFixture<TurnoDeProveedorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TurnoDeProveedorDeleteDialog);
