...
const routes: Routes = [
  ...
  {
    path: 'proveedor',
    data: { pageTitle: 'oncallApp.proveedor.home.title' },
    loadChildren: () => import('./proveedor/proveedor.routes'),
  },
  {
    path: 'contacto-de-proveedor',
    data: { pageTitle: 'oncallApp.contactoDeProveedor.home.title' },
    loadChildren: () => import('./contacto-de-proveedor/contacto-de-proveedor.routes'),
  },
  {
    path: 'turno-de-proveedor',
    data: { pageTitle: 'oncallApp.turnoDeProveedor.home.title' },
    loadChildren: () => import('./turno-de-proveedor/turno-de-proveedor.routes'),
  },
  {
    path: 'servicio-de-proveedor',
    data: { pageTitle: 'oncallApp.servicioDeProveedor.home.title' },
    loadChildren: () => import('./servicio-de-proveedor/servicio-de-proveedor.routes'),
  },
  {
    path: 'incidente-de-proveedor',
    data: { pageTitle: 'oncallApp.incidenteDeProveedor.home.title' },
    loadChildren: () => import('./incidente-de-proveedor/incidente-de-proveedor.routes'),
  },
  {
