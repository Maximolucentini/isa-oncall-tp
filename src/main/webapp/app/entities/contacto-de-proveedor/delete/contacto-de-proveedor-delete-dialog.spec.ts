...
import { ContactoDeProveedorDeleteDialog } from './contacto-de-proveedor-delete-dialog';

describe('ContactoDeProveedor Management Delete Component', () => {
  let comp: ContactoDeProveedorDeleteDialog;
  let fixture: ComponentFixture<ContactoDeProveedorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ContactoDeProveedorDeleteDialog);
