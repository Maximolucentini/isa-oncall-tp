...
public class ServicioCriteria implements Serializable, Criteria {
    ...
    private LongFilter proveedorDelQueDependeId;
    ...
    public ServicioCriteria(ServicioCriteria other) {
        ...
        this.proveedorDelQueDependeId = other.optionalProveedorDelQueDependeId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getProveedorDelQueDependeId() {
        return proveedorDelQueDependeId;
    }

    public Optional<LongFilter> optionalProveedorDelQueDependeId() {
        return Optional.ofNullable(proveedorDelQueDependeId);
    }

    public LongFilter proveedorDelQueDependeId() {
        if (proveedorDelQueDependeId == null) {
            setProveedorDelQueDependeId(new LongFilter());
        }
        return proveedorDelQueDependeId;
    }

    public void setProveedorDelQueDependeId(LongFilter proveedorDelQueDependeId) {
        this.proveedorDelQueDependeId = proveedorDelQueDependeId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(proveedorDelQueDependeId, that.proveedorDelQueDependeId) &&
    ...
    public String toString() {
        return "ServicioCriteria{" +
            ...
            optionalProveedorDelQueDependeId().map(f -> "proveedorDelQueDependeId=" + f + ", ").orElse("") +
