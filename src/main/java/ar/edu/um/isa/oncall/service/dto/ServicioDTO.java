...
public class ServicioDTO implements Serializable {
    ...
    private Set<ServicioDeProveedorDTO> proveedorDelQueDependes = new HashSet<>();
    ...
    public Set<ServicioDeProveedorDTO> getProveedorDelQueDependes() {
        return proveedorDelQueDependes;
    }

    public void setProveedorDelQueDependes(Set<ServicioDeProveedorDTO> proveedorDelQueDependes) {
        this.proveedorDelQueDependes = proveedorDelQueDependes;
    }
    ...
    public String toString() {
        return "ServicioDTO{" +
            ...
            ", proveedorDelQueDependes=" + getProveedorDelQueDependes() +
            "}";
    }
}
