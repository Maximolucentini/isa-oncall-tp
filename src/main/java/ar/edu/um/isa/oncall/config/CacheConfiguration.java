...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, ar.edu.um.isa.oncall.domain.Servicio.class.getName() + ".proveedorDelQueDependes");
            ...
            createCache(cm, ar.edu.um.isa.oncall.domain.Incidente.class.getName() + ".incidenteDeProveedors");
            ...
            createCache(cm, ar.edu.um.isa.oncall.domain.Proveedor.class.getName());
            createCache(cm, ar.edu.um.isa.oncall.domain.Proveedor.class.getName() + ".servicios");
            createCache(cm, ar.edu.um.isa.oncall.domain.Proveedor.class.getName() + ".contactos");
            createCache(cm, ar.edu.um.isa.oncall.domain.ContactoDeProveedor.class.getName());
            createCache(cm, ar.edu.um.isa.oncall.domain.ContactoDeProveedor.class.getName() + ".turnos");
            createCache(cm, ar.edu.um.isa.oncall.domain.TurnoDeProveedor.class.getName());
            createCache(cm, ar.edu.um.isa.oncall.domain.ServicioDeProveedor.class.getName());
            createCache(cm, ar.edu.um.isa.oncall.domain.ServicioDeProveedor.class.getName() + ".servicioInternos");
            createCache(cm, ar.edu.um.isa.oncall.domain.ServicioDeProveedor.class.getName() + ".tickets");
            createCache(cm, ar.edu.um.isa.oncall.domain.IncidenteDeProveedor.class.getName());
