...
public class Incidente implements Serializable {
    ...
    private Set<IncidenteDeProveedor> incidenteDeProveedors = new HashSet<>();
    ...
    public Set<IncidenteDeProveedor> getIncidenteDeProveedors() {
        return this.incidenteDeProveedors;
    }

    public void setIncidenteDeProveedors(Set<IncidenteDeProveedor> incidenteDeProveedors) {
        if (this.incidenteDeProveedors != null) {
            this.incidenteDeProveedors.forEach(i -> i.setIncidente(null));
        }
        if (incidenteDeProveedors != null) {
            incidenteDeProveedors.forEach(i -> i.setIncidente(this));
        }
        this.incidenteDeProveedors = incidenteDeProveedors;
    }

    public Incidente incidenteDeProveedors(Set<IncidenteDeProveedor> incidenteDeProveedors) {
        this.setIncidenteDeProveedors(incidenteDeProveedors);
        return this;
    }

    public Incidente addIncidenteDeProveedor(IncidenteDeProveedor incidenteDeProveedor) {
        this.incidenteDeProveedors.add(incidenteDeProveedor);
        incidenteDeProveedor.setIncidente(this);
        return this;
    }

    public Incidente removeIncidenteDeProveedor(IncidenteDeProveedor incidenteDeProveedor) {
        this.incidenteDeProveedors.remove(incidenteDeProveedor);
        incidenteDeProveedor.setIncidente(null);
        return this;
    }
