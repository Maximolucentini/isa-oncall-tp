...
public class IncidenteCriteria implements Serializable, Criteria {
    ...
    private LongFilter incidenteDeProveedorId;
    ...
    public IncidenteCriteria(IncidenteCriteria other) {
        ...
        this.incidenteDeProveedorId = other.optionalIncidenteDeProveedorId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getIncidenteDeProveedorId() {
        return incidenteDeProveedorId;
    }

    public Optional<LongFilter> optionalIncidenteDeProveedorId() {
        return Optional.ofNullable(incidenteDeProveedorId);
    }

    public LongFilter incidenteDeProveedorId() {
        if (incidenteDeProveedorId == null) {
            setIncidenteDeProveedorId(new LongFilter());
        }
        return incidenteDeProveedorId;
    }

    public void setIncidenteDeProveedorId(LongFilter incidenteDeProveedorId) {
        this.incidenteDeProveedorId = incidenteDeProveedorId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(incidenteDeProveedorId, that.incidenteDeProveedorId) &&
    ...
    public String toString() {
        return "IncidenteCriteria{" +
            ...
            optionalIncidenteDeProveedorId().map(f -> "incidenteDeProveedorId=" + f + ", ").orElse("") +
