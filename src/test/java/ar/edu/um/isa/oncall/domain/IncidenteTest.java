...
class IncidenteTest {
    ...
    @Test
    void incidenteDeProveedorTest() {
        Incidente incidente = getIncidenteRandomSampleGenerator();
        IncidenteDeProveedor incidenteDeProveedorBack = getIncidenteDeProveedorRandomSampleGenerator();

        incidente.addIncidenteDeProveedor(incidenteDeProveedorBack);
        assertThat(incidente.getIncidenteDeProveedors()).containsOnly(incidenteDeProveedorBack);
        assertThat(incidenteDeProveedorBack.getIncidente()).isEqualTo(incidente);

        incidente.removeIncidenteDeProveedor(incidenteDeProveedorBack);
        assertThat(incidente.getIncidenteDeProveedors()).doesNotContain(incidenteDeProveedorBack);
        assertThat(incidenteDeProveedorBack.getIncidente()).isNull();

        incidente.incidenteDeProveedors(new HashSet<>(Set.of(incidenteDeProveedorBack)));
        assertThat(incidente.getIncidenteDeProveedors()).containsOnly(incidenteDeProveedorBack);
        assertThat(incidenteDeProveedorBack.getIncidente()).isEqualTo(incidente);

        incidente.setIncidenteDeProveedors(new HashSet<>());
        assertThat(incidente.getIncidenteDeProveedors()).doesNotContain(incidenteDeProveedorBack);
        assertThat(incidenteDeProveedorBack.getIncidente()).isNull();
    }
}
